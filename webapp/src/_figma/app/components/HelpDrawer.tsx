      ...
      <div className="fixed right-0 top-0 bottom-0 w-96 bg-card border-l border-border z-50 overflow-y-auto">
        <div className="p-6">
          ...
          <div className="space-y-6">
            ...
            {/* ATO References */}
            {currentHelpContent.atoReferences && currentHelpContent.atoReferences.length > 0 && (
              <section className="pt-4 border-t border-border">
                <h3 className="text-sm font-semibold text-foreground mb-3">ATO References / Where to Verify</h3>
                <div className="space-y-3">
                  {currentHelpContent.atoReferences.map((ref, idx) => (
                    <a
                      key={idx}
                      href={ref.url}
                      target="_blank"
                    ...
                    >
                      <div className="flex items-start justify-between gap-2">
                        <div className="flex-1">
                          <div className="text-sm font-medium text-foreground group-hover:text-primary flex items-center gap-1">
                            {ref.title}
